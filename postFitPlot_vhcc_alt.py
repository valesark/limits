...
parser.add_argument('--channel',default='Zetau',help='Option to specify channel in case it is not obtainable from the shape file name')
...
parser.add_argument('--outdir',default='./',help='Optional string for the output folder')
...
if not args.doVZ :
  background_schemes = {
    'Wen':[backgroundComp("VH(H#rightarrowb#bar{b})",["ZH_hbb","WH_hbb"],881),
           signalComp("VH(H#rightarrowc#bar{c})"+(args.mu),["ZH_hcc","WH_hcc"],2,True),
    ...
    'Zmutau':[backgroundComp("VH(H#rightarrowb#bar{b})",["ZH_hbb","WH_hbb"],881),
           signalComp("VH(H#rightarrowc#bar{c})"+(args.mu),["ZH_hcc","WH_hcc"],2,True),
           backgroundComp("Z+udsg",["Zj_ll"],821),
           backgroundComp("Z+bj",["Zj_bj"],830),
           backgroundComp("Z+cj",["Zj_cj"],829),
    ...
    'Zetau':[backgroundComp("VH(H#rightarrowb#bar{b})",["ZH_hbb","WH_hbb"],881),
           signalComp("VH(H#rightarrowc#bar{c})"+(args.mu),["ZH_hcc","WH_hcc"],2,True),
           backgroundComp("Z+udsg",["Zj_ll"],821),
           backgroundComp("Z+bj",["Zj_bj"],830),
           backgroundComp("Z+cj",["Zj_cj"],829),
    ...
    'Zee':[backgroundComp("VH(H#rightarrowb#bar{b})",["ZH_hbb","ggZH_hbb"],881),
           signalComp("VH(H#rightarrowc#bar{c})"+(args.mu),["ZH_hcc","ggZH_hcc"],2,True),
           backgroundComp("Z+udsg",["Zj_ll"],821),
           backgroundComp("Z+bj",["Zj_bj"],830),
           backgroundComp("Z+cj",["Zj_cj"],829),
           backgroundComp("t#bar{t}",["TT"],866),
    ...
    'Znn':[backgroundComp("VH(H#rightarrowb#bar{b})",["ZH_hbb","WH_hbb","ggZH_hbb"],881),
           signalComp("VH(H#rightarrowc#bar{c})"+(args.mu),["ZH_hcc","WH_hcc","ggZH_hcc"],2,True),
...
if args.doVZ :
  background_schemes = {
    'Wen':[backgroundComp("VH(H#rightarrowb#bar{b})",["ZH_hbb","WH_hbb"],881),
           ...
           signalComp("VZ(Z#rightarrowc#bar{c})"+(args.mu),["VZcc"],607,True),
           backgroundComp("VV+other",["VVother"], 623),
           backgroundComp("Z+udsg",["Zj_ll"],821),
           backgroundComp("Z+bj",["Zj_bj"],830),
           backgroundComp("Z+cj",["Zj_cj"],829),
...
plot_background_schemes = {'Wen':[],'Wmn':[],'Zetau':[],'Zmutau':[],'Zee':[],'Zmm':[],'Znn':[]}
...
if args.subbkg==0:
  print("This is the output directory: ",args.outdir)
  c2.SaveAs(args.outdir+"%(outname)s.png"%vars())
  c2.SaveAs(args.outdir+"%(outname)s.pdf"%vars())
else:
  c2.SaveAs(args.outdir+"%(outname)s_unsub.png"%vars())
  c2.SaveAs(args.outdir+"%(outname)s_unsub.pdf"%vars())
